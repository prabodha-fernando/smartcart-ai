...
function FloatingAIAssistantInner(
  ...
  const [open, setOpen] = useTabState<boolean>("chat_open", false, (s) => s === true);
...
const FloatingAIAssistantInnerWithRef = forwardRef(FloatingAIAssistantInner);

export default forwardRef(function FloatingAIAssistant(
  props: { contextProduct?: LimitedProduct },
  ref: Ref<FloatingAIAssistantHandle>
) {
  return (
    <Suspense fallback={null}>
      <FloatingAIAssistantInnerWithRef {...props} ref={ref} />
    </Suspense>
  );
});
