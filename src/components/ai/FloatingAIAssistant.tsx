      ...
      <AnimatePresence>
        {open && (
          <motion.aside
            ...
            className="fixed inset-x-4 bottom-24 z-40 max-h-[calc(100vh-8rem)] overflow-y-auto rounded-[1.6rem] border border-white/70 bg-white/86 shadow-[0_28px_90px_rgba(15,23,42,0.24)] backdrop-blur-2xl sm:left-auto sm:right-6 sm:w-[min(42rem,calc(100vw-3rem))] md:bottom-28"
          >
